...
export function DashboardScreen() {
  return (
    ...
    <div className="flex h-full flex-col overflow-hidden rounded-2xl bg-[#f4f4f5]">
      ...
      <div
        className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden rounded-3xl p-4 md:p-6"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-6 overflow-auto md:flex-row md:overflow-hidden">
          {/* ── Left sidebar ────────────────────────────────────────────────── */}
        ...
        <div className="flex shrink-0 flex-col items-center gap-2 pt-2">
          <div
            ...
            style={{
              boxShadow: "0px 4px 6px 0px rgba(0,0,0,0.10), 0px 2px 4px 0px rgba(0,0,0,0.10)",
            }}
          >
            {/* ⌘ button */}
